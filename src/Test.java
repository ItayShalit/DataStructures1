public class Test{
	...
	public static void main (String[] args) {
		...
		printError(tree.isEmpty(), "Tree is not classified as empty.");
		printError(tree.keysToArray() == new int[0], "Problem N.1 with keysToArray");
		printError(tree.infoToArray() == new int[0], "Problem N.1 with infoToArray");
		...
		int[] values_sorted_by_keys = {8,6,7,2,5,1,3,4};
		...
		printError(tree.getRoot().getRight().size() == 6, "Problem N.3 with size");	
		...
		printError(tree.getRoot().getLeft().size() == 4, "Problem N.2 with size");	
